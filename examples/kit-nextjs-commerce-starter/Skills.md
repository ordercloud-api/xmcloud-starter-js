...
This file provides a starter-specific capability view for the **kit-nextjs-commerce-starter** app. Use it with the repository skills map to quickly choose the correct implementation pattern for App Router, XM Cloud layout rendering, OrderCloud commerce APIs, and editor-safe component work.
