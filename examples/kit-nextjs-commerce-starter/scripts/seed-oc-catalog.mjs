...
const productFacetDefinitions = [
  {
    id: "nike-demo-brand",
    body: { Name: "Brand", XpPath: "Facets.Brand", ListOrder: 10, MinCount: 1 },
  },
  {
    id: "nike-demo-product-type",
    body: {
      Name: "Product Type",
      XpPath: "Facets.ProductType",
      ListOrder: 20,
      MinCount: 1,
    },
  },
  {
    id: "nike-demo-activity",
    body: {
      Name: "Activity",
      XpPath: "Facets.Activity",
      ListOrder: 30,
      MinCount: 1,
    },
  },
...
const product = (
  ...
  body: {
    ...
    xp: {
      ...
      Category: category,
      Price: price,
      Facets: { Brand: brand, ProductType: productType, Activity: activity },
...
const specs = [
    ...
    body: {
      ...
      xp: {
        presentation: {
          ...
          helpText:
            "Add a second lace color to change up the Black Spruce colorway.",
        },
      },
    },
    options: [
      option("NO-EXTRA-LACES", "No Extra Laces", 10, {
        xp: {
          presentation: {
            ...
            description:
              "The standard Vintage Green laces included with the shoe",
          },
        },
      }),
  ...
  // Scenario 2: every size/color permutation is an active variant.
  {
    ...
    options: ["6", "7", "8", "9", "10", "11"].map((value, i) =>
      option(`W-${value}`, value, (i + 1) * 10),
    ),
    defaultOptionId: "W-8",
  },
  {
  ...
  // Scenario 3: generated size/color variants with selected combinations disabled.
  {
    ...
    options: ["7", "8", "9", "10", "11", "12"].map((value, i) =>
      option(`M-${value}`, value, (i + 1) * 10),
    ),
    ...
    body: {
      ...
      xp: {
        presentation: {
          ...
          label: "Select size",
          helpText:
            "US men's sizing. Choose your usual size for a snug, true-to-size fit.",
        },
      },
    },
    options: [
      ...
      ["M-11", "M 11 / W 12.5"],
      ["M-12", "M 12 / W 13.5"],
    ].map(([id, value], i) => option(id, value, (i + 1) * 10)),
    defaultOptionId: "M-10",
  },
  {
    productId: "aj1-love-letter-201",
    ...
    options: [
      option("SHADOW-BROWN", "Shadow Brown/Team Red", 10, {
        xp: {
          presentation: {
            label: "Shadow Brown",
      ...
      option("TEAM-RED", "Team Red/Sail", 20, {
      ...
      option("SAIL", "Sail/Light British Tan", 30, {
        xp: {
          presentation: {
            label: "Sail",
  ...
  },
  {
    ...
    options: [
      option("STANDARD", "Standard", 10, {
        xp: {
          presentation: { description: "Original insole and factory lacing" },
        },
      }),
      option("ROOMY", "Roomy", 20, {
        PriceMarkupType: "AmountPerQuantity",
        PriceMarkup: 8,
        xp: {
          presentation: {
  ...
  },
  {
    ...
    options: ["6", "7", "8", "9", "10", "11", "12", "13"].map((value, i) =>
      option(value, value, (i + 1) * 10),
    ),
    defaultOptionId: "10",
  },
  {
    ...
    body: {
      ...
      xp: {
        presentation: {
          ...
          helpText:
            "Start with a classic leather base or add a premium finish.",
        },
      },
    },
    options: [
      option("SMOOTH-LEATHER", "Smooth Leather", 10, {
        xp: {
          presentation: {
            label: "Smooth leather",
            description: "Clean, classic AF1 finish",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco,u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/42b73402-ca4d-4a01-8453-5f2786d4ef97/AIR+FORCE+1+LOW+ESS+NBY+LEA.png",
            badge: "Classic",
          },
        },
      }),
      option("RIPPLED-LEATHER", "Rippled Leather", 20, {
        PriceMarkupType: "AmountTotal",
        PriceMarkup: 10,
        xp: {
          presentation: {
            ...
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco,u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/318da3e1-037d-4c7e-8e62-8e8679041b3c/AIR+FORCE+1+LOW+ESS+NBY+LEA.png",
            badge: "Premium",
          },
        },
      }),
      option("CANVAS", "Canvas", 30, {
        ...
        xp: {
          presentation: {
            ...
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco,u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/9ee94934-b812-486e-a256-c386e2e243ac/AIR+FORCE+1+LOW+ESS+NBY+LEA.png",
          },
        },
      }),
    ],
  ...
  },
  {
    ...
    options: [
      option("SOLID", "Solid Rubber", 10, {
        xp: {
          presentation: {
            label: "Solid",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco,u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/6c612c89-2271-4ed1-b80c-3c2246c69bd7/AIR+FORCE+1+LOW+ESS+NBY+LEA.png",
          },
        },
      }),
      option("GUM", "Gum Rubber", 20, {
        PriceMarkupType: "AmountTotal",
        PriceMarkup: 5,
        xp: {
          presentation: {
            label: "Gum",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco,u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/fcfeb3c8-63c3-4383-b022-ce3a91332f6d/AIR+FORCE+1+LOW+ESS+NBY+LEA.png",
            badge: "Heritage",
          },
        },
      }),
      option("TRANSLUCENT", "Translucent Rubber", 30, {
        PriceMarkupType: "AmountTotal",
        PriceMarkup: 8,
        xp: {
          presentation: {
            label: "Translucent",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco,u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/122acb83-0f2c-4c2d-89cd-e81ae9cd3b7a/AIR+FORCE+1+LOW+ESS+NBY+LEA.png",
          },
        },
      }),
    ],
  ...
  },
  {
    ...
    body: {
      ...
      xp: {
        presentation: {
          ...
          helpText:
            "Choose the classic Nike Air logo or enter up to 3 characters.",
          placeholder: "ABC",
    ...
    options: [
      option("NIKE-AIR", "Nike Air Logo", 10, {
        xp: {
          presentation: {
            label: "Nike Air",
      ...
      option("CUSTOM-TEXT", "Custom Text", 20, {
        IsOpenText: true,
        PriceMarkupType: "AmountTotal",
        PriceMarkup: 8,
        xp: {
  ...
  },
  {
    ...
    options: ["XS", "S", "M", "L", "XL", "XXL", "3XL", "4XL"].map((value, i) =>
      option(value, value, (i + 1) * 10),
    ),
    defaultOptionId: "M",
  },
  ...
  },
  {
    ...
    body: {
      ...
      xp: {
        ...
        validation: { min: 1, max: 999, step: 1 },
      },
    },
  },
  {
    ...
    body: {
      ...
      xp: {
        presentation: {
          ...
          label: "Print notes",
          helpText:
            "Optional placement or capitalization notes for the print team.",
  ...
  },
  {
    ...
    body: {
      ...
      xp: {
        ...
        validation: { minDate: "today", maxDate: "2028-12-31" },
      },
    },
  },
  {
    ...
    options: [
      option("INDIGO-STORM", "Indigo Storm/Black", 10, {
        xp: {
          presentation: {
            label: "Indigo Storm",
            color: "#31566F",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco/85af0ecb-90e6-4705-996b-7371032179f8/NK+BRSLA+S+DUFF+-+X.png",
            badge: "Shown",
          },
        },
      }),
      option("BLACK", "Black/Black/White", 20, {
        xp: {
          presentation: {
            label: "Black",
            color: "#111111",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco/8447ce0a-4fe3-4112-ae1a-3dbe438f7f5c/NK+BRSLA+S+DUFF+-+X.png",
            badge: "Best seller",
          },
        },
      }),
      option("GAME-ROYAL", "Game Royal/Black/White", 30, {
        xp: {
          presentation: {
            label: "Game Royal",
            color: "#1D4E9E",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco/cb76bdfc-bec3-4b81-a382-e31f7200cb61/NK+BRSLA+S+DUFF+-+X.png",
          },
        },
      }),
      option("LIGHT-MAGENTA", "Light Magenta/Black", 40, {
        xp: {
          presentation: {
            label: "Light Magenta",
            color: "#D96C9D",
            imageUrl:
              "https://static.nike.com/a/images/t_PDP_144_v1/f_auto,q_auto:eco/b9e3968e-4ef1-49ae-b652-74fec933d097/NK+BRSLA+S+DUFF+-+X.png",
          },
        },
      }),
    ],
  ...
  },
  {
    ...
    options: [
      option("STANDARD", "Standard Strap", 10, {
        xp: {
          presentation: {
            label: "Standard",
  ...
  },
  {
    ...
    options: [
      option("NO-MONOGRAM", "No Monogram", 10, {
        xp: { presentation: { label: "No monogram" } },
      }),
      option("CUSTOM-MONOGRAM", "Custom Monogram", 20, {
        IsOpenText: true,
        PriceMarkupType: "AmountPerQuantity",
        PriceMarkup: 12,
        xp: {
...
const variantSpecsForProduct = (productId) =>
  specs.filter(
    (spec) => spec.productId === productId && spec.body.DefinesVariant === true,
  );
...
const validateCatalogConfiguration = () => {
  ...
  for (const scenario of catalogScenarios) {
    const productSpecs = specs.filter(
      (spec) => spec.productId === scenario.productId,
    );
    const variantSpecs = variantSpecsForProduct(scenario.productId);
    const ordinarySpecs = productSpecs.filter(
      (spec) => spec.body.DefinesVariant !== true,
    );
    const disabled = disabledVariantCombinations[scenario.productId] ?? [];
    const valid =
      (scenario.description === "pure specs (no variant specs)" &&
        ordinarySpecs.length > 0 &&
        variantSpecs.length === 0) ||
      (scenario.description === "all variant specs, none disabled" &&
        variantSpecs.length > 0 &&
        ordinarySpecs.length === 0 &&
        disabled.length === 0) ||
      (scenario.description ===
        "all variant specs, selected combinations disabled" &&
        variantSpecs.length > 0 &&
        ordinarySpecs.length === 0 &&
        disabled.length > 0) ||
      (scenario.description === "mixed ordinary and variant specs" &&
        variantSpecs.length > 0 &&
        ordinarySpecs.length > 0);
    if (!valid) {
      throw new Error(
        `Catalog scenario ${scenario.productId} is not configured as ${scenario.description}.`,
      );
    }
  }

  for (const [productId, combinations] of Object.entries(
    disabledVariantCombinations,
  )) {
    ...
    for (const combination of combinations) {
      ...
      if (JSON.stringify(actualSpecIds) !== JSON.stringify(expectedSpecIds)) {
        throw new Error(
          `Disabled variant for ${productId} must specify every variant spec.`,
        );
      }
      for (const spec of variantSpecs) {
        if (
          !(spec.options ?? []).some((item) => item.ID === combination[spec.id])
        ) {
          throw new Error(
            `Disabled variant for ${productId} references unknown option ${spec.id}/${combination[spec.id]}.`,
          );
        }
      }
    }
...
const listAllVariants = async (productId) => {
  ...
  while (true) {
    const response = await request(
      `list generated variants for ${productId}, page ${page}`,
      () => Products.ListVariants(productId, { page, pageSize: 100 }),
    );
...
const variantMatches = (variant, combination) => {
  const actual = Object.fromEntries(
    (variant.Specs ?? []).map((spec) => [spec.SpecID, spec.OptionID]),
  );
  return Object.entries(combination).every(
    ([specId, optionId]) => actual[specId] === optionId,
  );
};
...
const seed = async () => {
  ...
  if (!dryRun && (!clientId || !clientSecret)) {
    throw new Error(
      "Missing MIDDLEWARE_CLIENT_ID or MIDDLEWARE_CLIENT_SECRET. Set them in the environment or .env.",
    );
  }

  if (!dryRun) {
    console.log("Authenticating with OrderCloud client credentials...");
    const token = await request("client credentials authentication", () =>
      Auth.ClientCredentials(clientSecret, clientId),
    );
    if (!token?.access_token)
      throw new Error("OrderCloud authentication returned no access token.");
    Tokens.SetAccessToken(token.access_token);
  }

  await request(
    `save catalog ${catalogId}`,
    () =>
      Catalogs.Save(catalogId, {
        ID: catalogId,
        Name: catalogName,
        Active: true,
      }),
    { ID: catalogId, Name: catalogName },
  );
  for (const facet of productFacetDefinitions) {
    await request(
      `save product facet ${facet.id}`,
      () => ProductFacets.Save(facet.id, facet.body),
      { ID: facet.id, ...facet.body },
    );
  }
  for (const category of categoryDefinitions) {
    await request(
      ...
      () =>
        Categories.Save(catalogId, category.id, {
          ID: category.id,
          Name: category.name,
          Active: true,
        }),
  ...
  const assignments = await request(
    `list product assignments for ${catalogId}`,
    () => Catalogs.ListProductAssignments(catalogId, { pageSize: 100 }),
  );
  for (const assignment of assignments?.Items ?? []) {
    if (
      assignment.CatalogID === catalogId &&
      !expectedProductIds.has(assignment.ProductID)
    ) {
      await request(
        `remove stale product ${assignment.ProductID} from ${catalogId}`,
        () => Catalogs.DeleteProductAssignment(catalogId, assignment.ProductID),
        assignment,
      );
    }
  }
  ...
  for (const item of products) {
    ...
    await request(
      `save product ${item.id}`,
      () => Products.Save(item.id, item.body),
      item.body,
    );
    const priceScheduleId = `${item.id}-ps`;
    await request(
      `save price schedule ${priceScheduleId}`,
      () =>
        PriceSchedules.Save(priceScheduleId, {
          ID: priceScheduleId,
          Name: `${item.body.Name} Price`,
          ApplyTax: false,
          UseCumulativeQuantity: false,
          RestrictedQuantity: false,
          MinQuantity: 1,
          PriceBreaks: [{ Quantity: 1, Price: item.price }],
        }),
      { ID: priceScheduleId, Price: item.price },
    );
    await request(
      `patch product price ${item.id}`,
      () =>
        Products.Patch(item.id, { DefaultPriceScheduleID: priceScheduleId }),
      { DefaultPriceScheduleID: priceScheduleId },
    );
    const categoryId =
      item.body.xp.Category === "Running Apparel"
        ? "nike-apparel-demo-category"
        : item.body.xp.Category === "Training Accessories"
          ? "nike-accessories-demo-category"
          : rootCategoryId;
    await request(
      `assign product ${item.id} to ${categoryId}`,
      () =>
        Categories.SaveProductAssignment(catalogId, {
          CategoryID: categoryId,
          ProductID: item.id,
        }),
      { CategoryID: categoryId, ProductID: item.id },
    );
  }
  ...
  for (const spec of specs) {
    ...
    await request(
      `save spec ${spec.id}`,
      () => Specs.Save(spec.id, specBody),
      specBody,
    );
    for (const item of spec.options ?? [])
      await request(
        `save option ${spec.id}/${item.ID}`,
        () => Specs.SaveOption(spec.id, item.ID, item),
        item,
      );
    if (spec.defaultOptionId)
      await request(
        `set default ${spec.id}`,
        () => Specs.Patch(spec.id, { DefaultOptionID: spec.defaultOptionId }),
        { DefaultOptionID: spec.defaultOptionId },
      );
    await request(
      `assign spec ${spec.id} to ${spec.productId}`,
      () =>
        Specs.SaveProductAssignment({
          SpecID: spec.id,
          ProductID: spec.productId,
        }),
      { SpecID: spec.id, ProductID: spec.productId },
    );
  }
  ...
  const productsWithVariants = [
    ...new Set(
      specs
        .filter((spec) => spec.body.DefinesVariant === true)
        .map((spec) => spec.productId),
    ),
  ];
  for (const productId of productsWithVariants) {
    await request(
      `generate variants for ${productId}`,
      () =>
      ...
      { productId, overwriteExisting: true, Active: true },
    );
    ...
    if (dryRun) {
      for (const combination of disabled) {
        console.log(
          `[DRY_RUN] disable variant combination ${productId} ${JSON.stringify(combination)}`,
        );
      }
      continue;
    }
    ...
    for (const combination of disabled) {
      const matches = generatedVariants.filter((variant) =>
        variantMatches(variant, combination),
      );
      if (matches.length !== 1) {
        throw new Error(
          `Expected one generated variant for ${productId} ${JSON.stringify(combination)}, found ${matches.length}.`,
        );
      }
      await request(
        `disable variant ${productId}/${matches[0].ID}`,
        () =>
          Products.PatchVariant(productId, matches[0].ID, { Active: false }),
        { productId, variantId: matches[0].ID, combination, Active: false },
      );
    }
  }

  console.log(
    `Seed complete. Catalog: ${catalogId}, Category: ${rootCategoryId}`,
  );
  for (const scenario of catalogScenarios) {
